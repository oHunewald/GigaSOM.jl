...
datapath = "/Users/ohunewald/work/julia_k"
cd(datapath)

md = DataFrame(XLSX.readtable("metadata_p8.xlsx", "Sheet1", infer_eltypes=true)...)

panel = DataFrame(XLSX.readtable("panel_test.xlsx", "Sheet1", infer_eltypes=true)...)
